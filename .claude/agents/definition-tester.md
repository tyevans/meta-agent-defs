...
4. **Check the authoring rules** at `.claude/rules/agent-authoring.md` — but don't treat rule compliance as a proxy for quality. A definition can follow every rule and still be bad.
